              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Slider.adaptive(
                              ...
                              min: 0,
                              value: cubit.currentDuration.inSeconds.toDouble(),
                              onChanged: (v) {
                                cubit.seek(v.round());
                              }),
                        ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          IconButton(
                              onPressed: () {
                                if (cubit.indexChangeSong > 0) {
                                  cubit.changeSongNegative();
                                } else {
                                  return null;
                                }
                              },
                          ...
                          IconButton(
                              onPressed: () {
                                if (cubit.indexChangeSong <
                                    cubit.music.length - 1) {
                                  cubit.changeSongPlus();
                                } else {
                                  return null;
                                }
                              },
                    ...
                    Text(
                      cubit.music[cubit.indexChangeSong].replaceAll(".mp3", ""),
                      style: const TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                          fontWeight: FontWeight.bold),
